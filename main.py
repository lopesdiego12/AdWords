...
def download_campaign_perfomance_report(client, during):
	...
	for id in accounts_ids:
		...
		reports.download_report(client, report_query, 'CampaignPerformance\\campaign_performance_report_'+str(id)+'.csv')
...
if __name__ == '__main__':
	...
	client_adwords = adwords.AdWordsClient.LoadFromStorage('E\\AdWords\\Python\\googleads.yaml')
